...
const Navbar = () => {
  ...
  return (
    <nav 
      className="w-full h-1/6 flex flex-col items-start justify-center px-5 gap-5 rounded-xl bg-[#121212]"
    >
      <NavLink 
        to="/"
        ...
        <GoHome onClick={(e)=> handleClick(e)} id="home" className={`${isClickedHome ===true ? "text-white" : "text-stone-400"} text-3xl me-3`} />
